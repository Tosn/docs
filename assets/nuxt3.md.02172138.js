import{_ as n,c as s,o as a,a as t}from"./app.5330ff9d.js";const v='{"title":"# Proxy","description":"","frontmatter":{},"headers":[{"level":3,"title":"# Proxy","slug":"proxy"}],"relativePath":"nuxt3.md"}',p={},o=t(`<h3 id="proxy" tabindex="-1"># Proxy <a class="header-anchor" href="#proxy" aria-hidden="true">#</a></h3><div class="language-ts"><pre><code><span class="token comment">// /nuxt.config.ts</span>
